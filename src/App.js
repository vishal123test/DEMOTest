          ...
          >
            ...
            {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
              ...
              <>
                ...
                <s.SpacerXSmall />
                <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)", fontSize: "18px", fontFamily: "coder","Roboto","Oxygen","Ubuntu","Cantarell","Fira Sans","Droid Sans","Helvetica Neue","sansSerif" }}
                >
                  .01 eth
                </s.TextDescription>
                  <s.SpacerSmall />
